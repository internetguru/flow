...
- Do not remove ignored files when switching branches.
...
- Allow --pull to combine with --conform and other flags.
...
[3.2.3]: https://https://github.com/internetguru/flow/compare/v3.2.2...v3.2.3
